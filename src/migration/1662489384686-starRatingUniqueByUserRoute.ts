...
export class starRatingUniqueByUserRoute1662489384686
  implements MigrationInterface
{
  name = 'starRatingUniqueByUserRoute1662489384686';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "star_rating_vote" ALTER COLUMN "userId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "star_rating_vote" ALTER COLUMN "routeId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "star_rating_vote" ADD CONSTRAINT "UQ_f813b639d85decc8ae33e17d2e4" UNIQUE ("routeId", "userId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "star_rating_vote" ALTER COLUMN "routeId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "star_rating_vote" ALTER COLUMN "userId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "star_rating_vote" ADD CONSTRAINT "FK_59cdf2bf94368127c5f8b6096ee" FOREIGN KEY ("routeId") REFERENCES "route"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
